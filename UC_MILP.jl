...
@constraint(uc, UpTime[g=1:NG,t=MinUpTime[g]:T], sum(V[g,k] for k=t-MinUpTime[g]+1:t ) <= U[g,t] )
@constraint(uc, DwTime[g=1:NG,t=MinDwnTime[g]:T], sum(W[g,k] for k=t-MinDwnTime[g]+1:t ) <= 1 - U[g,t] )
